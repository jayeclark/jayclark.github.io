...
function drawBoard(board) {
  ...
  leftImg.src = './images/arrow.png';
  leftImg.style.transform = 'rotate(90deg)';
  ...
  leftArrow.zIndex = 2000;
  leftArrow.style.position = 'absolute';
  leftArrow.setAttribute('onclick','cache(\'left\')');

  let upArrow = document.createElement('div');
  let upImg = document.createElement('img');
  upImg.src = './images/arrow.png';
  ...
  upArrow.setAttribute('onclick','cache(\'up\')');

  let rightArrow = document.createElement('div');
  let rightImg = document.createElement('img');
  rightImg.src = './images/arrow.png';
  rightImg.style.transform = 'rotate(-90deg)';
  rightImg.width = arrowW;
  rightImg.height = arrowH;
  ...
  downImg.src = './images/arrow.png';
  downImg.width = arrowW;
  downImg.height = arrowH;
  ...
  downArrow.setAttribute('onclick','cache(\'down\')');
